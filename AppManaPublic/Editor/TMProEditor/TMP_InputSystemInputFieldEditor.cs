    ...
    public class TMP_InputSystemInputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    TMP_InputSystemInputField inputField = target as TMP_InputSystemInputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)TMP_InputSystemInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)TMP_InputSystemInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)TMP_InputSystemInputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)TMP_InputSystemInputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)TMP_InputSystemInputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)TMP_InputSystemInputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)TMP_InputSystemInputField.CharacterValidation.CustomValidator)
                        {
