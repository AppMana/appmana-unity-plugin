...
{
    /// <summary>
    /// A duplicate of the input system player settings helpers from v1.4.4 for the purposes of determining the
    /// enabled input backend
    /// </summary>
    internal static class InputSystemV144EditorPlayerSettingHelpers
    {
        /// <summary>
