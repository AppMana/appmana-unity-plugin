...
namespace AppMana.InteractionToolkit.MaterialUI
{
    /// <summary>
    ...
    public static class TransformExtension
    {
        ...
        public static void SetParentAndScale(this Transform transform, Transform parent, Vector3 localScale,
...
//            }
        ...
        public static Rect GetWorldSize(this RectTransform rectTransform)
        {
            Vector3[] corners = new Vector3[4];
            rectTransform.GetWorldCorners(corners);
