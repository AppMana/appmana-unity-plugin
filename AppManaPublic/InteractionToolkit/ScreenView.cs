...
namespace AppMana.InteractionToolkit
{
    ...
    public class ScreenView : UIBehaviour
    {
        ...
        public int currentScreen
        {
            ...
            set { m_CurrentScreen.Value = value; }
        }
        ...
        private void OnEditorUpdate()
        {
            ...
            if (m_MaterialScreens.Length > 0 && m_ScreensDirty)
            {
                ...
                if (m_OnlyShowSelectedScreen)
                {
                    ...
                    if (!screenSelected && !m_MaterialScreens[currentScreen].gameObject.activeSelf)
                    {
                        m_MaterialScreens[currentScreen].gameObject.SetActive(true);
                    }
                }
            }
            ...
            else if (m_MaterialScreens.Length > 0 && currentScreen >= m_MaterialScreens.Length)
            {
                currentScreen = m_MaterialScreens.Length - 1;
            }
        }
#endif
        ...
        protected override void Start()
        {
            if (Application.isPlaying)
            {
                if (m_MaterialScreens.Length > 0)
                {
                    ...
                    m_MaterialScreens[currentScreen].gameObject.SetActive(true);
                    m_MaterialScreens[currentScreen].rectTransform.SetAsLastSibling();
                }
            }
        }
        ...
        public void Transition(MaterialScreen materialScreen)
        {
        ...
        public void Transition(int screenIndex, Type transitionType)
        {
            ...
            m_MaterialScreens[currentScreen].Interrupt();

            if (transitionType == Type.In)
            {
                m_MaterialScreens[currentScreen].rectTransform.SetAsLastSibling();
                m_MaterialScreens[currentScreen].TransitionIn();
