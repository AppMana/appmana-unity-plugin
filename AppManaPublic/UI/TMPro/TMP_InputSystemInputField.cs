...
namespace AppMana.UI.TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/TextMeshPro - Input Field (AppMana-Compatible)", 11)]
    public class TMP_InputSystemInputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        protected TMP_InputSystemInputField()
        {
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            // #endif
            bool shift = Keyboard.current?.shiftKey.wasPressedThisFrame ?? false;
        ...
        public virtual void OnUpdateSelected(BaseEventData eventData)
        {
            ...
            // todo: this looks like it's interested if the selection was updated via a specific event
            // clicking on the field does nothing, produces a MouseDown event
            // hitting enter gives a keydown event which correctly submits, and hitting any character fires this event
